    ...
    <div class="max-w-[1200px] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="hidden lg:flex flex-col items-center justify-center p-12 illustration-container h-full">
            <div class="text-center max-w-sm">
                <img src="https://illustrations.popsy.co/blue/startup.svg" alt="Starting journey" class="w-full mb-8">
                <h2 class="text-[var(--dark-blue)] text-2xl font-bold mb-3">Your Journey Starts Here</h2>
                <p class="text-[var(--text-gray)] text-base leading-relaxed">
                    Create your account to unlock personalized learning paths and track your progress with AI.
                </p>
            </div>
        </div>
        ...
        <div class="w-full flex flex-col">
            <div class="mb-8 text-center lg:text-left">
                ...
                <h1 class="text-[28px] font-bold text-[var(--main-text)] mb-2">Create Account</h1>
                <p class="text-[var(--text-gray)] text-base">Join the community and start learning today.</p>
            </div>

            <div class="register-card p-6 md:p-10 w-full max-w-md mx-auto lg:ml-0">
                <form action="#" class="space-y-4" onsubmit="return false;">
                    
                    <div>
                        <label class="block text-[var(--dark-blue)] text-sm font-medium mb-1.5">Full Name</label>
                        <div class="relative">
                            <span class="absolute left-3 top-3 text-[#9CA3AF]">
                                <i data-lucide="user" class="w-5 h-5"></i>
                            </span>
                            <input type="text" placeholder="John Doe" class="input-field w-full pl-10 pr-4 text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        <label class="block text-[var(--dark-blue)] text-sm font-medium mb-1.5">Password</label>
                        <div class="relative">
                            <span class="absolute left-3 top-3 text-[#9CA3AF]">
                                <i data-lucide="lock" class="w-5 h-5"></i>
                            </span>
                            <input type="password" placeholder="At least 8 characters" class="input-field w-full pl-10 pr-4 text-sm">
                        </div>
                    </div>

                    <div class="flex items-start gap-3 py-2">
                        <input type="checkbox" id="terms" class="w-4 h-4 mt-1 border-[var(--border-gray)] rounded">
                        <label for="terms" class="text-xs text-[var(--text-gray)] leading-tight">
                            By creating an account, I agree to the <a href="#" class="text-[var(--primary-blue)] hover:underline">Terms of Service</a> and <a href="#" class="text-[var(--primary-blue)] hover:underline">Privacy Policy</a>.
                        </label>
                    </div>
                    ...
                    <div class="relative flex items-center py-2">
                        ...
                        <span class="flex-shrink mx-4 text-[var(--text-gray)] text-[11px] font-semibold uppercase tracking-widest">Or sign up with</span>
                        <div class="flex-grow border-t border-[var(--border-gray)]"></div>
                    </div>
                ...
                <div class="mt-8 pt-6 border-t border-[var(--border-gray)] text-center">
                    <p class="text-[var(--text-gray)] text-sm">
                        ...
                        <a href="#" class="text-[var(--primary-blue)] font-semibold hover:underline">Sign in</a>
                    </p>
                </div>
            </div>
            ...
            <div class="mt-8 flex items-start gap-4 p-4 bg-[var(--light-blue)]/60 rounded-[14px] w-full max-w-md mx-auto lg:ml-0 border border-[var(--primary-blue)]/10">
                ...
                <div>
                    <h4 class="text-sm font-semibold text-[var(--dark-blue)]">Smart Assistant</h4>
                    <p class="text-xs text-[var(--text-gray)] leading-relaxed mt-0.5">
                        I'm here to help you set up your profile! After registering, I can suggest the best courses based on your skills.
                    </p>
                </div>
            </div>
        </div>
