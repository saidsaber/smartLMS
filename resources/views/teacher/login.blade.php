...
<head>
    <meta charset="UTF-8">
    <title>Smart LMS – Teacher Login</title>
...
<body class="bg-lightBg min-h-screen flex items-center justify-center font-sans">
    ...
    <div class="bg-white w-full max-w-md p-8 rounded-[14px] shadow-lg">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-sm text-textGray">teacher Panel Login</p>
        </div>

        <!-- Login Form -->
        <form class="space-y-4" action="{{ route('teacher.login.post') }}" method="POST">
            @error('error')
            ...
            <div>
                ...
                <input type="email" placeholder="teacher@smartlms.com" name="email" value="{{ old('email') }}"
